...
There is a [tutorial notebook](https://carla-counterfactual-and-recourse-library.readthedocs.io/en/latest/notebooks/how_to_use_carla.html) available for a quick start.
