...
class ConstraintViolation(Evaluation):
    ...
    def constraint_violation(
        self, data: Data, counterfactuals: pd.DataFrame, factuals: pd.DataFrame
    ) -> List[List[float]]:
        """
        ...
        categorical_violations = (
            cfs_categorical_immutable != factual_categorical_immutable
        )
    ...
    def get_evaluation(self, counterfactuals, factuals):
        ...
        if counterfactuals_without_nans.empty:
            ...
            violations = self.constraint_violation(
